 ...
 * Editorial + Product design merge:
 *   - Near-black base, warm off-white text
 *   - Single accent color (warm amber/gold) for AI/DS brand
 *   - Secondary cool slate for subtle contrast
 *   - Instrument Serif for display, DM Sans for body
 */
export default {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        // Editorial display sizes — large, commanding, tight
